...
<<<<<<< HEAD
    if (upgrade.piety_cost && upgrade.piety_cost > you.piety)
    {
        ...
        return spret_type::abort; // I don't think this can ever happen right now.
    }
...
static potion_type _gozag_potion_list[][4] =
{
    ...
    { POT_HASTE, POT_AGILITY, POT_MIGHT, NUM_POTIONS },
    { POT_MIGHT, POT_AGILITY, POT_INVISIBILITY, NUM_POTIONS },
