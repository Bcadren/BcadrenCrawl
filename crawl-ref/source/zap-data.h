                              ...
                              colour_t colour = BLACK)
{
    return {
        ...
        player_pow_cap,
        nullptr,
        new tohit_calculator<30, 4, 1>,
        nullptr,
        new tohit_calculator<30, 4, 1>, // ENCH_POW_FACTOR
        colour,
        true,
        beam,
        NUM_DCHAR_TYPES,
...

{
    ...
    "magic candle",
    100,
    new calcdice_calculator<1, 1, 0, 0>,
    new tohit_calculator<9, 1, 12>,
    new calcdice_calculator<1, 1, 0, 0>,
    new tohit_calculator<17, 1, 25>,
    BLUE,
...

{
    ...
    "bolt of acid",
    200,
    new calcdice_calculator<3, 2, 2, 1>,
    new tohit_calculator<10, 1, 2>,
    new dicedef_calculator<3, 2, 2, 1>,
    new tohit_calculator<10, 1, 2>,
    YELLOW,
    false,
    BEAM_ACID,
...

{
    ...
    200,
    new calcdice_calculator<2, 2, 4, 3>,
