...
{
    MONS_DEATH_SCARAB, 's', GREEN, "death scarab",
    M_NO_SKELETON | M_BATTY,
    MR_NO_FLAGS,
    0, 12, MONS_DEATH_SCARAB, MONS_DEATH_SCARAB, MH_UNDEAD, 60,
    { {AT_BITE, AF_SCARAB, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 2, 3, 0 },
    7, 14, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 3, 6, 0 },
    8, 4, MST_FIRE_GIANT, CE_CLEAN, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_BITE, AF_DRAIN_XP, 20},
      AT_NO_ATK, AT_NO_ATK },
    { 9, 3, 5, 0 },
    3, 13, MST_ANUBIS_GUARD, CE_CLEAN, Z_SMALL, S_BARK,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    M_PRIEST | M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS,
    MR_NO_FLAGS,
    1500, 12, MONS_TROLL, MONS_DEEP_TROLL, MH_NATURAL, 40,
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, AT_NO_ATK },
...
// spectral weapon, for skalds!
{
    ...
    M_SHADOW | M_INSUBSTANTIAL | M_NO_REGEN | M_SPELL_PROXY,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD |  MR_RES_ELEC,
...

{
    ...
    0, 10, MONS_GOLEM, MONS_USHABTI, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 5, 3, 0 },
    9, 6, MST_USHABTI, CE_NOCORPSE, Z_NOZOMBIE, S_RUMBLE,
    I_NORMAL, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
...
// explodey things / orb of fire ('*')
{
    ...
    M_INSUBSTANTIAL | M_GLOWS_LIGHT | M_SPELL_PROXY,
...
{ // not an actual monster, used by a spell
    ...
    M_GLOWS_LIGHT | M_NO_POLY_TO | M_STATIONARY | M_SPELL_PROXY,
    mrd(MR_RES_POISON, 3) | mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 1),
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_GLOWS_LIGHT | M_NO_EXP_GAIN
        | M_NO_POLY_TO | M_MAINTAIN_RANGE | M_SPELL_PROXY,
    mrd(MR_RES_POISON | MR_RES_COLD | MR_RES_ELEC | MR_RES_FIRE, 2)
    | MR_RES_ACID | MR_RES_STICKY_FLAME,
...
{
    MONS_ROBIN, 'g', RED, "Robin",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    500, 10, MONS_GOBLIN, MONS_HOBGOBLIN, MH_NATURAL, 10,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 0, 0, 16 },
    1, 8, MST_ROBIN, CE_CLEAN, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    M_UNIQUE | M_SEE_INVIS | M_UNBLINDABLE | M_ACID_SPLASH | M_BURROWS | M_PRIEST | M_SPEAKS
        | M_FAST_REGEN,
    MR_RES_POISON | MR_RES_ASPHYX | mrd(MR_RES_ACID, 3),
