...
/* ******************************************************************
 ...
 - Some further explanations:
   ...
   gmon_use explanation:
        ...
        MU_MELEE   = MU_DOOR | MU_WEAPON_MELEE | MU_ARMOUR | MU_SHIELDS | MU_JEWELS,
        MU_ALL     = MU_MELEE | MU_WEAPON_RANGED | MU_WAND | MU_MISC,
    ...
    to define if a mon can open doors or not MU_THROW means sometimes spawns with 
    rocks/javelins/etc. MU_THROW_ALWAYS defines that it always has some kind of throwing item.

    Remaining flags define sorts of items the monster is allowed to pickup.
...
// centaurs ('c')
{
    ...
    MU_MELEE, SIZE_LARGE, MON_SHAPE_CENTAUR,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_MELEE, SIZE_BIG, MON_SHAPE_CENTAUR,
...

{
    ...
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MU_MELEE, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MU_DOOR, SIZE_SMALL, MON_SHAPE_HUMANOID_TAILED,
...
{ // a dummy monster for recolouring
    ...
    MU_START_ONLY, SIZE_LITTLE, MON_SHAPE_QUADRUPED,
...

{
    ...
    2, 12, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_START_ONLY, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// from those below. beware!
{
    ...
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_MISC,
...

{
    ...
    I_ANIMAL, HT_LAND, 10, MOVE_ENERGY(9),
    MU_DOOR, SIZE_LARGE, MON_SHAPE_MISC,
...

{
    ...
    MU_START_ONLY, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_MELEE, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_BIG, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    MU_DOOR, SIZE_BIG, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    MU_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    MU_MELEE, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// nagas ('N')
{
    ...
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MU_MELEE, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    I_HUMAN, HT_LAND, 7, DEFAULT_ENERGY,
    MU_DOOR, SIZE_BIG, MON_SHAPE_HUMANOID,
...
// Dummy monster for recolouring.
{
    ...
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MU_MELEE, SIZE_MEDIUM, MON_SHAPE_MISC,
...

{
    ...
    MU_MELEE, SIZE_MEDIUM, MON_SHAPE_NAGA,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_LARGE, MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MU_MELEE, SIZE_LARGE, MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    1, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MU_START_ONLY, SIZE_MEDIUM, MON_SHAPE_MISC,
...

{
    ...
    12, 1, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_START_ONLY, SIZE_LARGE, MON_SHAPE_MISC,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_MELEE, SIZE_MEDIUM, MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_GIANT, MON_SHAPE_SNAKE,
...
// "H"ybrids.
{
    ...
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MU_MELEE, SIZE_LARGE, MON_SHAPE_ARACHNID,
...
// Semi-unique in the moon base wizlab
{
    ...
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MU_MELEE, SIZE_BIG, MON_SHAPE_HUMANOID,
...
// Snails and other gastropods.
{
    ...
    MU_START_ONLY, SIZE_BIG, MON_SHAPE_SNAIL,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_START_ONLY, SIZE_LITTLE, MON_SHAPE_HUMANOID,
