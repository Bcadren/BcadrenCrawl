...

{
    ...
    M_INSUBSTANTIAL | M_GLOWS | M_FLIES,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_RES_ELEC
        | MR_VUL_WATER,
...

{
    ...
    M_SEE_INVIS | M_GLOWS | M_INSUBSTANTIAL | M_NO_REGEN
        | M_NO_POLY_TO | M_NO_EXP_GAIN | M_AVATAR | M_FLIES,
    mrd(MR_RES_COLD | MR_RES_FIRE, 2)
...
// player ghost - stats are stored in ghost struct
{
    ...
    M_FIGHTER | M_SPEAKS | M_INSUBSTANTIAL | M_NO_POLY_TO | M_FLIES,
    MR_NO_FLAGS,
...

{
    ...
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, {14, 10, 10, 10, 10, 10, 10, 100},
...

{
    ...
    { 15, 4, 5, 0 },
    5, 15, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, {8, 7, 10, 10, 10, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA
},
...
// spectral weapon, for skalds!
{
    ...
    M_INSUBSTANTIAL | M_NO_REGEN | M_AVATAR | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD |  MR_RES_ELEC,
...

{
   MONS_SPELLFORGED_SERVITOR, '8', LIGHTMAGENTA, "spellforged servitor",
    M_ARTIFICIAL | M_NO_POLY_TO | M_FLIES,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC,
...

{
    ...
    M_INSUBSTANTIAL | M_MAINTAIN_RANGE | M_SUBMERGES | M_FLIES,
...
{ // not an actual monster, used by a spell
    ...
    M_GLOWS | M_NO_POLY_TO | M_STATIONARY | M_CONJURED | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{ // not an actual monster, used by a spell
    ...
    M_NO_POLY_TO | M_STATIONARY | M_CONJURED | M_NO_EXP_GAIN | M_NO_POLY_TO
        | M_PROJECTILE | M_INSUBSTANTIAL | M_FLIES,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
