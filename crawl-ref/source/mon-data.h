...
{ // dummy for show_player_species
    MONS_VINE_STALKER, 'P', MAGENTA, "vine stalker",
    M_SPEAKS | M_NO_POLY_TO | M_FAST_REGEN | M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, 10, MONS_PLANT, MONS_VINE_STALKER, MH_PLANT, -4,
    { {AT_HIT, AF_ANTIMAGIC, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 3, 0 },
