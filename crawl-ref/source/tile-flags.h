...
enum tile_flags ENUM_INT64
{
    ...
    TILE_FLAG_CONFUSED     = 0x2000000000ULL,
    TILE_FLAG_BLACK_MARK   = 0x4000000000ULL,
    ...
    TILE_FLAG_WRETCHED     = 0x1000000000000000ULL,
    TILE_FLAG_MUTE         = 0x2000000000000000ULL,
    TILE_FLAG_DAZED        = 0x8000000000000000ULL,
